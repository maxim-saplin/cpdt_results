...
export default function DownloadLinks(props){
    return (
        <>
            <a href="https://github.com/maxim-saplin/CrossPlatformDiskTest/releases/download/2.1.0/CPDT.exe.zip" 
            target="_blank">
                <img src={windows}/>
                <br/>Windows
            </a>
            <a href="https://github.com/maxim-saplin/CrossPlatformDiskTest/releases/download/2.1.0/CPDT.app.zip" 
            target="_blank">
                <img src={macOS}/>
                <br/>macOS
            </a>
            ...
            <a href="https://github.com/maxim-saplin/CrossPlatformDiskTest/releases/download/2.1.0/com.Saplin.CPDT.apk" 
            target="_blank">
                <img src={apk}/>
                <br/>.APK
            </a>
