...
export default function About(props){
    return (
        <>
            <PressableLink className="leftCorner" onClick={props.toggleAbout}>[B] Назад</PressableLink>
            <br/><br/><br/>
            ...
            <div className="text">
                ...
                раздичная файловая система, разное количество свободного места), о чем отдельно указано в примечании под названием
                устройстваю.
                </p>
            </div>
            <br/>
            ...
            <div className="text">
                ...
                <p>
                Файловый кэш в памяти - влияет на тесты чтения. При любых файловых операциях, ОС либо переносит данные с диска в память (чтение), либо из памяти на диск (запись). При этом данные будут оставлены в памяти до тех пор, пока она не потребуется другим приложениям. При получении запроса на чтение из файла, ОС проверит, считывались ли данные из файл ранее и содержится ли они уже в памяти. При наличии закешированных данных в памяти, ОС не будет обращаться к файлу и сделает копипрвание из памяти (которое сущетсвенно быстрее доступа к диску). Включение данной опции по сути тестирует не устройство хранение, а механизм кеширования и ОЗУ.
                </p>
            </div>
        </>
    )
